...
public class S3 {
     ...
     * 보내야 할 옷의 개수 n이 주어질 때, 배송비를 최소화할 수 있는 상자의 개수를 return하도록 solution 함수를 완성하세요. 어떠한 방법으로도 모든 옷을 보낼 수 없다면 -1을 반환하면 됩니다.
     * 제한사항
     ...
     * 입출력 예 설명
     * 입출력 예 #1
     * n = 15라면 5개들이 상자 3개에 나누어 배송하는 것이 최적의 방법이므로 3을 반환합니다.
     * 입출력 예 #2
     * n = 7이라면 위의 규칙으로 배송할 방법이 없으므로 -1을 반환합니다.
     */
}
